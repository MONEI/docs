...
If you are using [WooCommerce Plugin](/e-commerce/woocommerce) or [custom domain](https://dashboard.monei.com/settings/custom-domain) with [MONEI Hosted Payment Page](integrations/use-prebuilt-payment-page.mdx) your domain is verified automatically.
...
You can also verify your domain with Apple using [MONEI REST API](/api/#operation/domain_register).
