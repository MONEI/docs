...
:::note
PayPal Component is also available as React and Vue component. [Check out our examples](monei-js/overview.mdx#card-input-component).
:::

Check [MONEI JS Reference](monei-js/reference.md#paypal-component) for more options.
