...
Our [PayPal UI Component](monei-js/reference.md#moneipaypal-component) renders PayPal button to your payment page.
...
This page explains how to add PayPal to your custom payment page. If you don't need custom a checkout experience we recommend using our [prebuilt payment page](integrations/use-prebuilt-payment-page.mdx). It already supports all available payment methods and does not require coding.
...
Add MONEI [PayPal Component](monei-js/reference.md#moneipaypal-component) to your payment page. Create empty DOM node (container) with unique ID in your payment form.
...
Check [MONEI JS Reference](monei-js/reference.md#moneipaypal-component) for more options.
