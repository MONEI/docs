...
You can start accepting Apple Pay payments on the Web using [Hosted Payment Page](use-prebuilt-payment-page.mdx) or [PaymentRequest UI Component](monei-js/reference.md#moneigooglepay-component). No additional configuration is required to use Apple Pay in Hosted Payment Page.
