...
**Endpoint:** `https://service.microapps-staging.com/v1/sepa-request-to-pay-requests`
...
```json
{
    "callbackUrl": "https://testing-srtp.galitt.com/005/callback",
    "Document": {
        "CdtrPmtActvtnReq": {
            "GrpHdr": {
                "MsgId": "Id20***3731",
                    ...
                    "CdtTrfTx": [
                        {
                            ...
                            "RltdRmtInf": {
                                ...
                                "RmtLctnDtls": [
                                    {
                                        "Mtd": "URID",
                                        "ElctrncAdr": "david.molina@monei.com"
                                    }
                                ]
                            },
                            "RmtInf": {
...
**Endpoint:** `https://service.microapps-staging.com/v1/sepa-request-to-pay-requests/{{resourceId}}/status-update`
...
**Endpoint:** `https://service.microapps-staging.com/v1/sepa-request-to-pay-requests/{{resourceId}}/cancellation-requests`
...
**Endpoint:** `https://service.microapps-staging.com/v1/sepa-request-to-pay-requests/{{resourceId}}/cancellation-requests/{{cancellationResourceId}}/status-update`
