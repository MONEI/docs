...
The business can issue refunds directly through the [MONEI dashboard](https://dashboard.monei.com) within a period of one year. If the business wishes to issue a refund for a transaction older than a year, please contact our [Support Team](https://support.monei.com/hc/requests/new).
