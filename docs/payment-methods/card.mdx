...
The business can make refunds/returns themselves within a period of one year, from the Canales-Redsys Virtual POS administration panel. If the business wishes to make returns from more than a year ago, they must manage them at the management office.
