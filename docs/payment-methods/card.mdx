...
The business can make refunds themselves within a period of one year, from the [MONEI dashboard](https://dashboard.monei.com). If the business wishes to issue a refund older than a year.
