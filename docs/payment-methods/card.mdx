...
You can start accepting credit card payments on the Web using [Hosted Payment Page](integrations/use-prebuilt-payment-page.mdx) or [Card Input Component](monei-js/reference.md#cardinput-component). No additional configuration is required for the Hosted Payment Page. It already supports all available payment methods and does not require coding.
...
:::note
Card Input Component is also available as React and Vue component. [Check out our examples](monei-js/overview.mdx#card-input-component).
:::
