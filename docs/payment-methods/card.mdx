...
Our [CardInput UI Component](monei-js/reference.md#moneicardinput-component) renders a card input to your payment page. The CardInput UI Component lets you securely collect card information all within one component. It includes a dynamically-updating card brand icon as well as inputs for number, expiry and CVC. If a customer enters a card that requires 3D Secure confirmation the payment confirmation step will automatically show a 3D Secure confirmation popup.
...
Add MONEI [Card Input Component](monei-js/reference.md#moneicardinput-component) to your payment page. Create empty DOM nodes (containers) with unique IDs in your payment form.
...
Check [MONEI JS Reference](monei-js/reference.md#moneicardinput-component) for more options.
