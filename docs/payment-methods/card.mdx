...
Our [Card Input Component](monei-js-api.md#moneicardinput-component) renders a Card Input in your payment form. The Card Input Component lets you collect card information all within one Component. It includes a dynamically-updating card brand icon as well as inputs for number, expiry and CVC. If a customer enters a card that requires 3D Secure confirmation the payment confirmation step will automatically show a 3D Secure confirmation popup.
