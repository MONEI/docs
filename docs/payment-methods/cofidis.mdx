...
After the payment is completed the customer is redirected to the `completeUrl` with **payment_id** query parameter, you can obtain the status of the payment by calling [get payment](/docs/apis/rest/payments-get/) endpoint.
