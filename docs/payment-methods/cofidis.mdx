...
We also provide a [Cofidis Widget Component](monei-js/reference.md#cofidis-widget-component) that dynamically calculates the conditions for a loan based on the given price. You can put this widget on the product page, cart or checkout to inform your customers about the commercial conditions.
