...
Check our guide [how to add it to your cart or checkout page](guides/setup-cofidis-widget.mdx).

:::caution
If you are using Cofidis payment method it is mandatory to put [view details](https://monei.com/cofidis/) link or Cofidis Widget to your cart or checkout page.
:::
