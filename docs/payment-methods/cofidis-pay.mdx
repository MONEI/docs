...
import {CofidisPay} from '../../src/components/CofidisPay';
import {CofidisPayWidget} from '../../src/components/CofidisPayWidget';
...
:::caution
If you are using Cofidis {ay payment method it is mandatory to put [view details](https://monei.com/cofidis-pay/) link or Cofidis Pay Widget to your cart or product page.
:::
