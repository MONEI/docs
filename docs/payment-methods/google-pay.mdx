...
- [Request production access](https://developers.google.com/pay/api/web/guides/test-and-deploy/request-prod-access) to obtain production `merchantID` in Google Business Console.
- Contact our [Support Team](mailto:support@monei.com) and submit a request providing your `merchantID` to configure Google Pay in production.
