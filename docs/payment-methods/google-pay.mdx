...
- [Request production access](https://developers.google.com/pay/api/web/guides/test-and-deploy/request-prod-access) to obtain production **Merchant ID** in Google Business Console.
