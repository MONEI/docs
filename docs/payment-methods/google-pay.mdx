...
- You can check the status of a Google Pay test payment in your [MONEI Dashboard → Payments](https://dashboard.monei.com/payments)
...
- Contact our [Support Team](mailto:support@monei.com) and submit a request providing your `merchantID` to configure Google Pay.
