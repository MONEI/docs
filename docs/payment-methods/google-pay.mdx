...
- Make sure that you have a [default credit card processor](https://dashboard.monei.com/settings/payment-methods/card)
- [Request production access](https://developers.google.com/pay/api/web/guides/test-and-deploy/request-prod-access) to obtain production **Merchant ID** in Google Business Console. Make sure you specify **monei** as your payment gateway.
- Contact our [Support Team](mailto:support@monei.com) and submit a request providing your MONEI **Account ID** and Google **Merchant ID** to configure Google Pay in production.
