...
:::note
We recommend using our new [Payment Request Component](monei-js/payment-request.mdx) instead of Google Pay Component. [Payment Request Component](monei-js/reference.md#moneigooglepay-component) gives you a single integration for Apple Pay and Google Pay. Customers see a Google Pay or an Apple Pay button, depending on what their device and browser combination supports.
:::
...
:::note
Google Pay Component is also available as React and Vue component. [Check out our examples](monei-js/overview.mdx#card-input-component).
:::

Check [MONEI JS Reference](monei-js/reference.md#googlepay-component) for more options.
