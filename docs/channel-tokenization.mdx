...
- `<payment_token>`: **MONEI's created token of booking card information**. This token is typically used in [subsequent transactions](http://localhost:3000/docs/apis/rest/payments-create/) instead of the actual card details for security reasons.
