...
- **amount** `positive integer` - Amount intended to be collected by this payment. A positive integer representing how much to payment in the smallest currency unit (e.g., 100 cents to payment 1.00 USD)
...
- **amount** `required` `positive integer` - Amount intended to be collected by this payment. A positive integer representing how much to payment in the smallest currency unit (e.g., 100 cents to payment 1.00 USD)
