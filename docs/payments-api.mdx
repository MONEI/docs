...
- **nextAction** `object` - If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
  - **type** `string` - Next action type, one of:
    - `CONFIRM` - Your customer needs to be redirected to a [hosted payment page](use-prebuilt-payment-page.mdx) or confirm payment using [payment token](accept-card-payment.mdx#3-submitting-the-payment-to-monei-client-side). The **redirectUrl** will point to the hosted payment page.
...
curl --request POST 'https://api.monei.net/v1/payments/26d1f09c42bb59a29b06e280f9553cd5/capture' \
--header 'Authorization: pk_test_3c140607778e1217f56ccb8b50540e00'
```
...
const options = {
  method: 'POST',
  url: 'https://api.monei.net/v1/payments/26d1f09c42bb59a29b06e280f9553cd5/capture',
  headers: {
    Authorization: 'pk_test_3c140607778e1217f56ccb8b50540e00'
  }
};
...
$client = new http\Client;
$request = new http\Client\Request;
$request->setRequestUrl('https://api.monei.net/v1/payments/26d1f09c42bb59a29b06e280f9553cd5/capture');
$request->setRequestMethod('POST');
$request->setOptions(array());
$request->setHeaders(array(
  'Authorization' => 'pk_test_3c140607778e1217f56ccb8b50540e00'
