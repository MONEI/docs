...
Search for **MONEI WooCommerce** Plugin in your WordPress store or download it from official WordPress plugins page.

![Install MONEI WooCommerce](/img/configure-woo-0.png)

<p>
  <a href="https://github.com/MONEI/MONEI-WooCommerce/archive/refs/heads/master.zip" target="_blank" className="button button--primary">
