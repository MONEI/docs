...
description: This document outlines the process of payment card tokenization, where credit card information is received.
---
...
- `<last4>`: Represents the last four digits of the credit card number.
- `<brand>`: Denotes the brand or card network associated with the credit card. In this example, "MC" likely stands for MasterCard.
- `<cardHolderName>`: Provides the name of the cardholder associated with the credit card, this field contains the name of the person to whom the credit card belongs.
