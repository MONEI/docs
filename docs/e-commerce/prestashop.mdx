...
<p>
  <a href="https://github.com/MONEI/MONEI-PrestaShop/releases/latest/download/monei.zip" target="_blank" className="button button--primary">
    Download MONEI Official Module
  </a>
</p>
