...
You can install MONEI Magento 2 Extension from the raw package by downloading the [latest version](https://github.com/MONEI/MONEI-AdobeCommerce-Magento2/archive/refs/heads/main.zip).

Create a directory called `app/code/Monei`, inside your magento2 project, and you unzip the downloaded archive there.

Go to Magento 2 root directory and run:
