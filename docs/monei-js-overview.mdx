...
MONEI UI Components is a set of rich, prebuilt UI components that help you create your own checkout flows across desktop and mobile.

UI components include features like:

- Format Credit Card information automatically as it’s entered
...
- Apple Pay, Google Pay, PayPal, Bizum UI components for easy integration into your checkout flow
- All UI Components are available in JavaScript, ReactJS, Vue and Angular.
...
Card Input UI Component is completely customizable. You can style it to match the look and feel of your site, providing a seamless checkout experience for your customers. It’s also possible to style various input states, for example when the input has focus.

To see all available MONEI UI Components check the [API docummentation](monei-js-api.md) or our integration guides for individual payment methods.
