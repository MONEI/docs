...
MONEI POS payments is the best way to accept payments in-store.

Login into https://tpv.monei.com/ with your same credentials you use to access https://dashboard.monei.com/ and start creating payments
