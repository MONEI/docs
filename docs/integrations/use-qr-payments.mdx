...
description: MONEI QR payments is the simplest way to securely accept in-store contactless payments and support all the most popular payment methods with QR codes.
---
...
MONEI QR payments are in **open beta**. To get started please contact our [Support Team](https://support.monei.com/hc/requests/new). We will send you a _"welcome pack"_ with a set of QR stickers to get you up and running.

<div className="video-wrapper">
  <iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/oj2i-mH3Mtg"
...
Login into https://tpv.monei.com/ with your credentials from https://dashboard.monei.com/ and register received QR codes. After registering the QR code you can create a payment that will be automatically attached to this QR code.
...
<div className="flex-container">
  ...
  <img src="/img/qr-demo.png" alt="QR demo" width="420" />
</div>
