...
<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link-preview.png" alt="Pay By Link" width={760} />
</div>

## Overview

This page explains how to create payment links from the [MONEI Dashboard](#create-from-dashboard) or programmatically using the [MONEI Payments API](#integration-steps).
...
Go to [MONEI Dashboard → Payments](https://dashboard.monei.com/payments) and click the **Pay By Link** button.

<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/dashboard-payments.png" alt="Dashboard Payments" width={760} />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/create-payment-form.png" alt="Create Payment Form" width={520} />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/billing-address.png" alt="Billing Address" width={540} />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/manual-capture.png" alt="Manual Capture" width={540} />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/send-payment-request.png" alt="Send Payment Request" width={400} />
</div>
...
<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/delivery-channel.png" alt="Delivery Channel" width={540} />
</div>

<div style={{textAlign: 'center'}}>
  <img src="/img/pay-by-link/customer-language.png" alt="Customer Language" width={540} />
</div>
