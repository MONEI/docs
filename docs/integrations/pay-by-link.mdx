...
id: pay-by-link
title: Pay By Link
description: Use Pay By Link to send your customers a link to pay online in one click! Works with or without a website. Send payment links via email or SMS.
---

Send your customers a unique link to pay online in one click!
...
### 2. Send payment link to your customer.
...
Use payment `id` to send a payment link to your customer.
