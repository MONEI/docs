...
This page explains how to create payment links programmatically using [MONEI Payments API](/docs/apis/rest/payments-create/). You can also create payment links in your [MONEI Dashboard](https://dashboard.monei.com/).
...
Create a [Payment](/docs/apis/rest/schemas/payment/) on your server with an amount and currency.
...
See the full list of [request parameters](/docs/apis/rest/payments-send-link/).
