...
:::warning
Payouts API is currently in a closed beta. If you want to use it, please contact our [Support Team](https://support.monei.com/hc/requests/new)
:::

## Before you begin

This page explains how to do payouts with Bizum or card. If you don't have Bizum payment method configured, please contact our [Support Team](https://support.monei.com/hc/requests/new).
