...
The Payouts flow is not available in the MONEI testing environment. However, you can use the [MONEI API endpoint](https://docs.monei.com/api/#tag/Bizum) to verify if the phone number is registered with Bizum.
