...
You can use the [MONEI API endpoint](https://docs.monei.com/api/#tag/Bizum) to verify if the phone number is registered with Bizum before sending the money to the end user.
...
Check the full list of returned [response parameters](/docs/apis/rest/schemas/payment/).
