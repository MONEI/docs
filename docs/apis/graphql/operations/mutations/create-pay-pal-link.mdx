---
id: create-pay-pal-link
title: createPayPalLink
---
...
#### [<code style={{ fontWeight: 'normal' }}><b>PayPalLink</b></code>](/docs/apis/graphql/types/objects/pay-pal-link.mdx) <Badge class="badge badge--secondary " text="object"/>
