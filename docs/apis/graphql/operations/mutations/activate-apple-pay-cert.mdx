---
id: activate-apple-pay-cert
title: activateApplePayCert
---
...
#### [<code style={{ fontWeight: 'normal' }}>activateApplePayCert.<b>input</b></code>](#)<Bullet />[<code style={{ fontWeight: 'normal' }}><b>ActivateApplePayCertInput</b></code>](/docs/apis/graphql/types/inputs/activate-apple-pay-cert-input.mdx) <Badge class="badge badge--secondary " text="input"/>
