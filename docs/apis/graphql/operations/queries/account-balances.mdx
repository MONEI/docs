...
#### [<code style={{ fontWeight: 'normal' }}><b>AccountBalancesConnection</b></code>](/docs/apis/graphql/types/objects/account-balances-connection.mdx) <Badge class="badge badge--secondary " text="object"/>
