---
id: notifications-portal-url
title: notificationsPortalUrl
---
...
#### [<code style={{ fontWeight: 'normal' }}><b>Redirect</b></code>](/docs/apis/graphql/types/objects/redirect.mdx) <Badge class="badge badge--secondary " text="object"/>
