...
#### [<code style={{ fontWeight: 'normal' }}><b>AvailablePaymentMethod</b></code>](/docs/apis/graphql/types/objects/available-payment-method.mdx) <Badge class="badge badge--secondary " text="object"/>
