---
id: paymentstatuscodes
title: 'PaymentStatusCodes'
...
sidebar_label: 'PaymentStatusCodes'
hide_title: true
...
<Heading as={'h1'} className={'openapi__heading'} children={'PaymentStatusCodes'}></Heading>
...
<Schema
  schema={{
    ...
    allOf: [{type: 'string', example: 'E000'}],
    title: 'PaymentStatusCodes'
  }}
  schemaType={'response'}
></Schema>
