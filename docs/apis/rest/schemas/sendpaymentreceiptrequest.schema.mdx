---
id: sendpaymentreceiptrequest
title: 'SendPaymentReceiptRequest'
description: ''
sidebar_label: 'SendPaymentReceiptRequest'
hide_title: true
...
<Heading as={'h1'} className={'openapi__heading'} children={'SendPaymentReceiptRequest'}></Heading>
