...
The request also contains a `MONEI-Signature` header. [Verify this signature](how-to-verify-signature.mdx) to confirm that received request is sent from MONEI.
